...
encoder_layer = [28*28, 1000, 400]
z_dim = 2
decoder_layer = [400, 1000, 28*28]
...
for epoch in range(num_epochs):
    ...
    print("Epoch {:3d}/{:d}, loss_en_de {:9f}, loss_dis_faker {:9f}, loss_dis_real {:9f}, loss_encoder {:9f}"
          .format(epoch+1, num_epochs, loss_encoder_decoder,
                  math.exp(-loss_disor_faker), math.exp(-loss_disor_real), math.exp(-loss_encoder)))
